...
# Test_Name
test_name = "Descargar Informe de Salud Individual CET desde Sucursal Virtual Empresa Mutual"
...
if __name__ == "__main__":
    ...
    from BuscarInformesDeEvaluacion_Indiv_SVE import BuscarInformesDeEvaluacion_Indiv_SVE
    driver = BuscarInformesDeEvaluacion_Indiv_SVE(driver)
