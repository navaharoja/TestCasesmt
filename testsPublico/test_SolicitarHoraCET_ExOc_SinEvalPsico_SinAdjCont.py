...
# Test_Name
test_name = "Solicitar horas CET - Examen Ocupacional - Sin Evaluacion Psicologica"
...
if __name__ == "__main__":
    ...
    from LlenarFormularioCET_SolicitudHoraCet import LlenarFormularioCET_SolicitudHoraCet_ExOc
    driver = LlenarFormularioCET_SolicitudHoraCet_ExOc(driver)
    ...
    from LlenarFormularioCET_EvaPsico import LlenarFormularioCET_EvaPsico_Vacio
    driver = LlenarFormularioCET_EvaPsico_Vacio(driver)
    ...
    from LlenarFormularioCET_NomTrab import LlenarFormularioCET_NomTrab
    driver = LlenarFormularioCET_NomTrab(driver)
